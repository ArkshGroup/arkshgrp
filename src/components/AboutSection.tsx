    ...
    <main className="bg-white font-sans">
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        <div className="flex flex-col items-start gap-6">
          ...
          <h2 className="text-5xl font-medium text-[#2c3e50] mb-4">Who Are We?</h2>
          <div className="space-y-6 text-[#5d6d7e] leading-relaxed text-lg text-justify">
            <p>
              ...
              entrepreneur, founded Rajesh Concern with a focus on trade and hospitality. Through
              importing various goods from around the world, Rajesh Concern played a vital role in
              promoting Nepal and strengthening trade relations with many countries. His dedication
              and success made him one of the most accomplished importers in Nepal, committed to
              serving their customers diligently.
            </p>{' '}
            <p>
              Arksh Group has now evolved into a versatile and dynamic business conglomerate. The
              Group has diversified its reach across various sectors and is engaged in a wide range
              of businesses including automobiles, food industry, hotels & restaurants, food &
              beverages, metal & minerals, tours & travels, carpet & flooring, clothing & shoes,
              health & wellness, beauty & cosmetics, IT and more. The group's import & export
              division conducts trade with countries like Australia, Switzerland, Turkey, UAE,
              Singapore, Korea, Vietnam, Malaysia, Thailand, China, India etc expanding its global
              presence.
            </p>
            <p>
              Today, Arksh Group stands as one of the most trusted business groups in Nepal. It's
              impressive growth is a result of deeply understanding local markets, people, and
              customs, allowing them to excel in every segment of their business. Apart from making
              significant contributions to Nepal's economy it also create employment opportunities
              and promote entrepreneurship in the country.
            </p>
            <p>
              Arksh Group's journey embodies dedication, understanding, and adaptability. It's
              diverse portfolio and commitment to excellence have made the group a leading business
              force in Nepal, touching every aspect of the business world and positively impacting
      ...
      <section className="bg-gray-50 py-20 px-6 ">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex flex-col items-center mb-12">
            ...
            <h2 className="text-5xl font-bold text-[#3498db]">Our Vision & Mission</h2>
          ...
          <div className="mb-16">
            ...
            <div className="inline-block">
              <div
                className="bg-white inline-flex items-center gap-4 px-8 py-4 rounded-xl 
                    shadow-sm border border-gray-100 mb-6
                    transition-all duration-300 ease-out
                    hover:-translate-y-2 hover:shadow-lg hover:scale-[1.02] cursor-pointer"
              >
                <div
                  className="bg-[#3498db] p-2.5 rounded-lg text-white 
                ...
                <span className="text-3xl font-bold text-[#3498db]">Our Vision</span>
              </div>
            </div>

            {/* Vision Content Card */}
            <div
              className="bg-white p-10 rounded-2xl border-t-4 border-[#3498db] 
                  shadow-md max-w-4xl mx-auto
                  transition-all duration-500 ease-out
                  hover:-translate-y-3 hover:shadow-2xl hover:scale-[1.01] cursor-pointer"
            >
          ...
          <div className="flex flex-col items-center">
            <div
              className="bg-white inline-flex items-center gap-4 px-8 py-4 rounded-xl 
             shadow-sm border border-gray-100 mb-10 cursor-pointer
             transition-all duration-300 ease-out
            ...
            >
              ...
              >
                <RocketLaunchIcon className="w-7 h-7 transition-transform duration-300 group-hover:scale-110" />
              </div>

              <span className="text-3xl font-bold text-[#3498db] transition-colors duration-300">
                Our Mission
              </span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
             ...
             hover:-translate-y-2 hover:shadow-xl hover:border-t-4 hover:scale-[1.02]"
                >
                  <h4 className="text-[#3498db] text-xl font-bold mb-3 transition-colors duration-300">
                    {item.title}
                  </h4>

                  <p className="text-gray-500 text-[15px] leading-relaxed transition-colors duration-300">
                    {item.desc}
                  </p>
                </div>
              ))}
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <div className="flex flex-col items-center mb-16">
            ...
            <h2 className="text-5xl font-bold text-[#3498db]">The Principles That Guide Us</h2>
